...
const GetStarted = ({header, text, button}) => {
  return (
    <div className="my-[100px] justify-center items-center flex">
      <div className="grid xxs:grid-cols-1 md:grid-cols-2 w-[90%] max-w-[1500px]  border-2 border-gray-900 border-opacity-60 text-white gap-[20]">

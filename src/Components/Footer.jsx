  ...
  return (
    <footer className="bg-gray-800 text-white w-screen overflow-hidden z-[20] py-4">
      <div className="container mx-auto  xxs:px-2  sm:px-6 md:px-6  max-w-[1500px]">
        <div className="lg:grid xxs:flex justify-center  flex-col xxs:items-center xxs:text-center lg:text-start lg:items-start  lg:grid-cols-5 gap-2">
          <img src='/porche.png' className='w-[50px]' />
          {/* Product Section */}
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/" className="hover:text-gray-300">User Guides</Link>
              </li>
              <li>
                <Link href="/blog" className="hover:text-gray-300">Webinars</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contact" className="hover:text-gray-300">Join Us</Link>
              </li>
            </ul>
          </div>
          ...
          <div className='w-full felx'>
            ...
            <a href="#" className="hover:text-gray-300 ">For product announcements and exclusive insights</a>
